...
class Lobby extends React.Component {
    ...
    render() {
        ...
        let simbut;
        if (user && (user.uid==="CLJxLSE29JSvVUPjYB6y2aGOqVn1" || user.name === "Geoff")) {simbut = <button onClick={() => this.props.simulateJoin(lobby.slug)}>Simulate Players Joining</button>}
        return (
            <>
            <div>
            ...
            <button onClick={() => this.props.goToPage("/")}>Main Menu</button>
            </>
        );
    }
}
